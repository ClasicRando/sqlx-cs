    ...
    public Task When_NotNullStructValueTypeAndNoCustomDecoderSpecified()
    {
        const string source = 
            ...
            public static class TestExtensions
            {
                ...
                public static partial void Bind(this IBindable query, PgTimeTz value);
            }
            """;
    ...
    public Task When_NotNullStructValueTypeAndCustomDecoderSpecified()
    {
        const string source = 
            ...
            public static class TestExtensions
            {
                ...
                public static partial void Bind(this IBindable query, System.Guid value);
            }
            """;
     ...
     public Task When_NullableClassValueTypeAndNoCustomDecoderSpecified()
     {
         const string source = 
             ...
             {
                 [GeneratePgBindMethod]
                 public static partial void Bind(this IBindable query, string? value);
             }
             """;
