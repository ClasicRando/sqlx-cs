...
internal class PgFromRowImplementationGenerator : ISourceGenerationPipeline<PgFromRowToGenerate>
{
    ...
    {
        StringBuilder builder = SourceGenerationHelper.CreateInitialSourceGeneratedFileBuilder();
        builder.AppendNamespaceDeclaration(pgFromRowToGenerate.ContainingNamespace);
