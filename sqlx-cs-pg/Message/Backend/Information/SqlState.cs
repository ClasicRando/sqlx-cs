    ...
    extension(SqlState sqlState)
    {
        public static SqlState FromChars(ReadOnlySpan<char> chars)
        {
            return chars switch
            {
                ...
                NoAdditionalDynamicResultSetsReturned => SqlState
                    .NoAdditionalDynamicResultSetsReturned,
                ...
                SqlClientUnableToEstablishSqlConnection => SqlState
                    .SqlClientUnableToEstablishSqlConnection,
                SqlServerRejectedEstablishmentOfSqlConnection => SqlState
                    .SqlServerRejectedEstablishmentOfSqlConnection,
                ...
                StackedDiagnosticsAccessedWithoutActiveHandler => SqlState
                    .StackedDiagnosticsAccessedWithoutActiveHandler,
                ...
                InvalidArgumentForWidthBucketFunction => SqlState
                    .InvalidArgumentForWidthBucketFunction,
                ...
                InvalidArgumentForSqlJsonDatetimeFunction => SqlState
                    .InvalidArgumentForSqlJsonDatetimeFunction,
                ...
                HeldCursorRequiresSameIsolationLevel => SqlState
                    .HeldCursorRequiresSameIsolationLevel,
                InappropriateAccessModeForBranchTransaction => SqlState
                    .InappropriateAccessModeForBranchTransaction,
                InappropriateIsolationLevelForBranchTransaction => SqlState
                    .InappropriateIsolationLevelForBranchTransaction,
                NoActiveSqlTransactionForBranchTransaction => SqlState
                    .NoActiveSqlTransactionForBranchTransaction,
                ReadOnlySqlTransaction => SqlState.ReadOnlySqlTransaction,
                SchemaAndDataStatementMixingNotSupported => SqlState
                    .SchemaAndDataStatementMixingNotSupported,
                ...
                DependentPrivilegeDescriptorsStillExist => SqlState
                    .DependentPrivilegeDescriptorsStillExist,
                ...
                TransactionIntegrityConstraintViolation => SqlState
                    .TransactionIntegrityConstraintViolation,
                ...
                InternalError => SqlState.InternalError,
                DataCorrupted => SqlState.DataCorrupted,
                IndexCorrupted => SqlState.IndexCorrupted,
        ...
        private bool IsCriticalPoolError => CriticalErrors.Contains(sqlState);

        public (string ErrorCode, string ConditionName) Details
        {
            get
            {
                return sqlState switch
                {
                    ...
                    SqlState.StringDataRightTruncation => (StringDataRightTruncation,
                        "string_data_right_truncation"),
                    SqlState.DeprecatedFeature => (DeprecatedFeature, "deprecated_feature"),
                    SqlState.NoData => (NoData, "no_data"),
                    SqlState.NoAdditionalDynamicResultSetsReturned => (
                        NoAdditionalDynamicResultSetsReturned,
                    ...
                    SqlState.InvalidLocatorSpecification => (InvalidLocatorSpecification,
                    ...
                    SqlState.StackedDiagnosticsAccessedWithoutActiveHandler => (
                        StackedDiagnosticsAccessedWithoutActiveHandler,
                    ...
                    SqlState.InvalidPrecedingOrFollowingSize => (InvalidPrecedingOrFollowingSize,
                    ...
                    SqlState.InvalidTableSampleArgument => (InvalidTableSampleArgument,
                        "invalid_tablesample_argument"),
                    SqlState.InvalidTableSampleRepeat => (InvalidTableSampleRepeat,
                    ...
                    SqlState.SequenceGeneratorLimitExceeded => (SequenceGeneratorLimitExceeded,
                        "sequence_generator_limit_exceeded"),
                    SqlState.StringDataLengthMismatch => (StringDataLengthMismatch,
                        "string_data_length_mismatch"),
                    SqlState.StringDataRightTruncation2 => (StringDataRightTruncation2,
                        "string_data_right_truncation"),
                    ...
                    SqlState.DuplicateJsonObjectKeyValue => (DuplicateJsonObjectKeyValue,
                        "duplicate_json_object_key_value"),
                    SqlState.InvalidArgumentForSqlJsonDatetimeFunction => (
                        InvalidArgumentForSqlJsonDatetimeFunction,
                        "invalid_argument_for_sql_json_datetime_function"),
                    SqlState.InvalidJsonText => (InvalidJsonText, "invalid_json_text"),
                    SqlState.InvalidSqlJsonSubscript => (InvalidSqlJsonSubscript,
                        "invalid_sql_json_subscript"),
                    SqlState.MoreThanOneSqlJsonItem => (MoreThanOneSqlJsonItem,
                        "more_than_one_sql_json_item"),
                    SqlState.NoSqlJsonItem => (NoSqlJsonItem, "no_sql_json_item"),
                    SqlState.NonNumericSqlJsonItem => (NonNumericSqlJsonItem,
                        "non_numeric_sql_json_item"),
                    SqlState.NonUniqueKeysInAJsonObject => (NonUniqueKeysInAJsonObject,
                        "non_unique_keys_in_a_json_object"),
                    SqlState.SingletonSqlJsonItemRequired => (SingletonSqlJsonItemRequired,
                        "singleton_sql_json_item_required"),
                    SqlState.SqlJsonArrayNotFound => (SqlJsonArrayNotFound,
                        "sql_json_array_not_found"),
                    SqlState.SqlJsonMemberNotFound => (SqlJsonMemberNotFound,
                        "sql_json_member_not_found"),
                    SqlState.SqlJsonNumberNotFound => (SqlJsonNumberNotFound,
                        "sql_json_number_not_found"),
                    SqlState.SqlJsonObjectNotFound => (SqlJsonObjectNotFound,
                        "sql_json_object_not_found"),
                    SqlState.TooManyJsonArrayElements => (TooManyJsonArrayElements,
                        "too_many_json_array_elements"),
                    SqlState.TooManyJsonObjectMembers => (TooManyJsonObjectMembers,
                        "too_many_json_object_members"),
                    SqlState.SqlJsonScalarRequired => (SqlJsonScalarRequired,
                    ...
                    SqlState.HeldCursorRequiresSameIsolationLevel => (
                        HeldCursorRequiresSameIsolationLevel,
                        "held_cursor_requires_same_isolation_level"),
                    SqlState.InappropriateAccessModeForBranchTransaction => (
                        InappropriateAccessModeForBranchTransaction,
                        "inappropriate_access_mode_for_branch_transaction"),
                    SqlState.InappropriateIsolationLevelForBranchTransaction => (
                        InappropriateIsolationLevelForBranchTransaction,
                        "inappropriate_isolation_level_for_branch_transaction"),
                    SqlState.NoActiveSqlTransactionForBranchTransaction => (
                        NoActiveSqlTransactionForBranchTransaction,
                        "no_active_sql_transaction_for_branch_transaction"),
                    SqlState.ReadOnlySqlTransaction => (ReadOnlySqlTransaction,
                        "read_only_sql_transaction"),
                    SqlState.SchemaAndDataStatementMixingNotSupported => (
                        SchemaAndDataStatementMixingNotSupported,
                    ...
                    SqlState.IdleInTransactionSessionTimeout => (IdleInTransactionSessionTimeout,
                    ...
                    SqlState.DependentPrivilegeDescriptorsStillExist => (
                        DependentPrivilegeDescriptorsStillExist,
                    ...
                    SqlState.ModifyingSqlDataNotPermitted => (ModifyingSqlDataNotPermitted,
                        "modifying_sql_data_not_permitted"),
                    SqlState.ProhibitedSqlStatementAttempted => (ProhibitedSqlStatementAttempted,
                        "prohibited_sql_statement_attempted"),
                    SqlState.ReadingSqlDataNotPermitted => (ReadingSqlDataNotPermitted,
                    ...
                    SqlState.ModifyingSqlDataNotPermitted2 => (ModifyingSqlDataNotPermitted2,
                        "modifying_sql_data_not_permitted"),
                    SqlState.ProhibitedSqlStatementAttempted2 => (ProhibitedSqlStatementAttempted2,
                        "prohibited_sql_statement_attempted"),
                    SqlState.ReadingSqlDataNotPermitted2 => (ReadingSqlDataNotPermitted2,
                        "reading_sql_data_not_permitted"),
                    SqlState.ExternalRoutineInvocationException => (
                        ExternalRoutineInvocationException,
                        "external_routine_invocation_exception"),
                    SqlState.InvalidSqlstateReturned => (InvalidSqlstateReturned,
                        "invalid_sqlstate_returned"),
                    SqlState.NullValueNotAllowed2 => (NullValueNotAllowed2,
                    ...
                    SqlState.EventTriggerProtocolViolated => (EventTriggerProtocolViolated,
                        "event_trigger_protocol_violated"),
                    SqlState.SavepointException => (SavepointException, "savepoint_exception"),
                    SqlState.InvalidSavepointSpecification => (InvalidSavepointSpecification,
                    ...
                    SqlState.UnsafeNewEnumValueUsage => (UnsafeNewEnumValueUsage,
                    ...
                    SqlState.InternalError => (InternalError, "internal_error"),
                    SqlState.DataCorrupted => (DataCorrupted, "data_corrupted"),
                    SqlState.IndexCorrupted => (IndexCorrupted, "index_corrupted"),
                    _ => throw new InvalidOperationException($"Invalid SqlState: {sqlState}"),
                };
            }
        }
    }
