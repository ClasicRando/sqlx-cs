...
/// will then receive zero or more copy data messages as part of the protocol.
/// </para>
...
internal readonly record struct CopyOutResponseMessage(CopyResponse Response)
    : IPgBackendMessage, IPgBackendMessageDecoder<CopyOutResponseMessage>
{
    public static PgBackendMessageType MessageType => PgBackendMessageType.CopyOutResponse;
